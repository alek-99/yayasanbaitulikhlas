...
export default function FooterSection() { // 2. HAPUS kata 'async' di sini
        ...
        <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-12">
          ...
          <div className="flex flex-col gap-4">
            ...
            <p className="text-sm leading-relaxed">
              Lembaga sosial yang berkomitmen untuk membahagiakan anak-anak yatim.
            </p>
          </div>
          ...
          <div>
            ...
            <ul className="space-y-3 text-sm">
              <li>
                <Link href="#tentang" className="hover:text-green-400 transition-colors">
                  Profil Yayasan
                </Link>
              </li>
              <li>
                <Link href="#program" className="hover:text-green-400 transition-colors">
                  Program
                </Link>
              </li>
              <li>
                <Link href="#artikel" className="hover:text-green-400 transition-colors">
                  Artikel
                </Link>
              </li>
            </ul>
  ...
  <a href="https://www.facebook.com/profile.php?id=100076234412073" aria-label="Facebook">
    <i className="fab fa-facebook-f hover:text-blue-500 transition-colors"></i>
  </a>

  <a href="https://www.instagram.com/yayasanbaitulikhlas?igsh=MTRjNm10eml0eXUzaw==" aria-label="Instagram">
    <i className="fab fa-instagram hover:text-pink-500 transition-colors"></i>
  </a>

  <a href="https://www.youtube.com/@yayasanbaitulikhlaspeduliy4989" aria-label="YouTube">
    <i className="fab fa-youtube hover:text-red-500 transition-colors"></i>
  </a>

  <a href="https://www.tiktok.com/@yayasan.baitul.ik?is_from_webapp=1&sender_device=pc" aria-label="TikTok">
    <i className="fab fa-tiktok hover:text-white transition-colors"></i>
        ...
        <div className="border-t border-slate-900 mt-16 pt-8 text-center text-sm">
          © {new Date().getFullYear()} Yayasan Baitul Ikhlas. All Rights Reserved.
        </div>
      </div>
    </footer>
  );
